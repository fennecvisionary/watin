...
import { Menu, X, Heart, Search, HelpCircle, UserPlus, Droplets, Megaphone, ChartColumnBig } from 'lucide-react';
      ...
      <div className="nav-inner">
        ...
        <div className={`nav-links ${menuOpen ? 'open' : ''}`}>
          ...
          <a href="#stats" onClick={() => setMenuOpen(false)}>
            <ChartColumnBig size={14} style={{ display: 'inline', verticalAlign: 'middle', marginLeft: 4 }} />
            الإحصائيات
          </a>
          <a href="#support" onClick={() => setMenuOpen(false)}>
            <Megaphone size={14} style={{ display: 'inline', verticalAlign: 'middle', marginLeft: 4 }} />
            ادعمنا
          </a>
