                ...
                <div className="stats-table-wrap">
                  <table className="stats-table">
                    ...
                    <tbody>
                      {bloodCounts.map((row) => (
                        <tr key={row.blood}>
                          <td data-label="الزمرة">{row.blood}</td>
                          <td data-label="عدد المتبرعين">{row.count.toLocaleString('ar-DZ')}</td>
                          <td className="stats-progress-cell" data-label="النسبة">
                      ...
                      <tr className="stats-total-row">
                        <td data-label="الزمرة">الإجمالي</td>
                        <td data-label="عدد المتبرعين">{donors.length.toLocaleString('ar-DZ')}</td>
                        <td data-label="النسبة">100%</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                  ...
                  <table className="stats-table">
                    ...
                    <tbody>
                      {topWilayas.map((row, index) => (
                        <tr key={row.wilaya}>
                          <td data-label="الترتيب"><span className="rank-badge">{index + 1}</span></td>
                          <td data-label="الولاية">{row.wilaya}</td>
                          <td data-label="عدد المتبرعين">{row.count.toLocaleString('ar-DZ')}</td>
                          <td className="stats-progress-cell" data-label="المساهمة">
                            <div className="stats-progress-track">
                              <span
                                className="stats-progress-fill"
